...
Beim ersten Aufruf fragt der Browser nach den Zugangsdaten (Benutzername `admin`, Passwort aus `secrets.h`) – änderbar unter Einstellungen → Zugang (Login).
...
Live-Daten und Charts direkt im Browser## Schnellstart: TaupunktLueftung auf ESP32
